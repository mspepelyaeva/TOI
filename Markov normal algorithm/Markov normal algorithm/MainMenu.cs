    ...
    public partial class MainMenu : Form
    {
        ...
        private void AlphabetInputButton_Click(object sender, EventArgs e)
        {
            if (AlphabetInputTextBox.Text != "")
            {
                ...
                MessageBox.Show("Алфавит введен успешно!", "Ввод алфавита", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Вы не ввели алфавит! Пожалуйста, повторите ввод.", "Ввод алфавита", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
        ...
        private void Start_Click(object sender, EventArgs e)
        {
            if (Alphabet.Count == 0)
            {
                MessageBox.Show("Алфавит не задан!", "Проверка ввода", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            if (InputTextBox.Text.Length == 0)
            {
                MessageBox.Show("Заполните входную строку!", "Проверка ввода", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            if (!lettersCheck)
            {
                MessageBox.Show("Слово содержит символы, не принадлежащие алфавиту", "Проверка ввода", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            if (dataGridView1.Rows.Count == 0)
            {
                MessageBox.Show("Введите хотя бы одно условие!", "Проверка ввода", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                if (v0 != null && (v1 == null || v2 == null) ||
                    v1 != null && (v2 == null || v0 == null) ||
                    v2 != null && (v0 == null || v1 == null))
                {
                    MessageBox.Show("Заполните поля формы подстановки!", "Проверка ввода", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
            }
        ...
        public bool Contains(string EnterText)
        {
            ...
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
            {
                ...
                string l = dataGridView1.Rows[i].Cells[0].Value.ToString();
                if (EnterText.Contains(l))
                {
                    b = 1;
                }
            }
